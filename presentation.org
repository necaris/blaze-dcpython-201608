...
* TODO: [/]
  - [ ] move source data to source-data dir
  - [ ] add extract-and-load scripts for DBs
  - [ ] export presentation to web-renderable
  - [ ] push to public repo
  - [ ] fiddle with seeing reveal.js presentations on github -- GH Pages?
